...
Artefaktbeskrivningar: `docs/artifacts/descriptions/2. Målarkitektur/` · Mallar: `docs/artifacts/templates/2. Målarkitektur/` · Översikt: `docs/artifacts/Artifacts.md`
