# Artefakter – Outputs från Varje Fas

Varje process-fas producerar definierade artefakter (deliverables). Denna katalog listar alla artefakttyper, deras beskrivningar och mallar.

## Artefakt-kategorier per Process-fas
