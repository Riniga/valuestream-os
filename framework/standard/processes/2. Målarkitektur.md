...
```mermaid
flowchart LR
    A1["Delprocess 1: Etablera arkitekturell grund"] --> A2["Delprocess 2: Definiera domänmodell"]
    A2 --> A3["Delprocess 3: Etablera målarkitektur"]
    A3 --> A4["Input till nästa processsteg (Roadmap)"]
```
...
## Delprocess 1: Etablera arkitekturell grund
...
- uppdaterade `Arkitekturprinciper`
- definierade `Icke-funktionella krav`
- en sammanställd `Målarkitektur`
